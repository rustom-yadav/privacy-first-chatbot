...
import type { DocumentInfo, SessionSummary } from '@/lib/types';
          ...
          {uploadSuccess && (
            <div className="mb-3 mx-4 px-3 py-2.5 rounded-xl bg-brand-primary/10 border border-brand-primary/20 animate-fade-in shrink-0">
              <div className="flex items-start gap-2">
                ...
                <p className="text-xs text-brand-primary flex-1">
                  {uploadSuccess}
                </p>
                <button
                  onClick={onDismissSuccess}
                  className="text-brand-primary/50 hover:text-brand-primary cursor-pointer"
                >
                  <svg
